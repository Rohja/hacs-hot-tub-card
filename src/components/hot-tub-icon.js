    ...
    return html`
      ...
      >
        ...
        >
          ...
          >
            <path
              style="fill:var(--primary-color);stroke:#FFFFFF;stroke-width:0.27357298px;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1"
            ...
            <ellipse
              ...
              style="opacity:${this.scaleBrightness()}%;fill:${this
                .lightsColor};fill-opacity:1;stroke:#FFFFFF;stroke-width:1;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1;paint-order:markers stroke fill;filter:url(#filter6274)"
            ...
            <ellipse
              ...
              display="${this.lightsState === "on" ? "block" : "none"}"
              style="opacity:${this.scaleBrightness()}%;fill:${this
                .lightsColor};fill-opacity:1;stroke:#FFFFFF;stroke-width:1;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1;paint-order:markers stroke fill;filter:url(#filter6270)"
            ...
            <ellipse
              ...
              display="${this.lightsState === "on" ? "block" : "none"}"
              style="opacity:${this.scaleBrightness()}%;fill:${this
                .lightsColor};fill-opacity:1;stroke:#FFFFFF;stroke-width:1;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1;paint-order:markers stroke fill;filter:url(#filter6278)"
            ...
            <ellipse
              ...
              display="${this.lightsState === "on" ? "block" : "none"}"
              style="opacity:${this.scaleBrightness()}%;fill:${this
                .lightsColor};fill-opacity:1;stroke:#FFFFFF;stroke-width:1;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1;paint-order:markers stroke fill;filter:url(#filter6266)"
            ...
            <ellipse
              ...
              display="${this.lightsState === "on" ? "block" : "none"}"
              style="opacity:${this.scaleBrightness()}%;fill:${this
                .lightsColor};fill-opacity:1;stroke:#FFFFFF;stroke-width:1;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1;paint-order:markers stroke fill;filter:url(#filter6262)"
              inkscape:label="light_led_1"
              transform="matrix(1.541647,0,0,1.7126816,-44.55627,-154.45341)"
            />
            <path
              id="spa"
              style="fill:none;stroke:#FFFFFF;stroke-width:3.2742;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1"
